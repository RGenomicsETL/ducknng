...
if (!requireNamespace("duckdb", quietly = TRUE) ||
    as.character(packageVersion("duckdb")) != "1.5.0") {
  stop("rendering this release README requires the duckdb 1.5.0 R package")
}
...
options(duckknit.duckdb = "/usr/local/bin/duckdb150")
local({
